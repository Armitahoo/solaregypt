...
# Calculate electricity demand per capita
egypt_data['electricity_demand_per_capita'] = egypt_data['electricity_demand'] / egypt_data['population']

# Plot the electricity demand per capita
plt.figure(figsize=(12, 6), dpi=300)
plt.plot(egypt_data['year'], egypt_data['electricity_demand_per_capita'], marker='o', color='blue', linewidth=2)
