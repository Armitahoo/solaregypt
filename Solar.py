...
cost_per_year = electricity_consumption_per_capita * cost_per_kwh *population

# Step 2: Total cost over the lifespan per capita
total_cost_over_lifespan_per_capita = cost_per_year * lifespan

# Step 3: Calculate the present value
# Formula for the present value of an annuity: PV = C * (1 - (1 + r)^-n) / r
present_value = cost_per_year * ((1 - (1 + interest_rate) ** -lifespan) / interest_rate)
